...
import { useDateSegment, useInteractOutside, useLocale, useTimeField, type DateValue, type TimeValue } from "react-aria"
import {
  useDatePickerState,
  useTimeFieldState,
  type DateFieldState,
  ...
  return (
    <Popover open={open} onOpenChange={setOpen} aria-label="Date Time Picker">
      <PopoverTrigger asChild>
        <Button
          variant={"outline"}
          className={cn("h-12 min-w-[240px] justify-start text-left", !props.value && "text-muted-foreground")}>
