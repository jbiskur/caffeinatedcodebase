...
/**
 * v0 by Vercel.
 * @see https://v0.dev/t/p8PwQMckSo6
      ...
      <div className="container mx-auto px-4 py-12 sm:px-6 lg:px-8 grid md:grid-cols-[2fr_1fr] gap-8">
        <article className="prose prose-gray mx-auto max-w-3xl dark:prose-invert">
          <div className="space-y-2 not-prose">
            <h1 className="text-4xl font-extrabold tracking-tight lg:text-5xl">The Art of Minimalist Living</h1>
          ...
          <p>
            In a world filled with constant distractions and material excess, the concept of minimalist living has
            gained significant traction. At its core, minimalism is about intentionally focusing on what truly matters,
            and letting go of the unnecessary clutter that can weigh us down both physically and mentally.
          </p>
          <p>
            By embracing a minimalist lifestyle, we can create a sense of tranquility and clarity in our lives. It's
            about finding joy in the essentials, and cultivating a deep appreciation for the simple things. Whether it's
            decluttering our living spaces, curating a wardrobe of timeless pieces, or simplifying our daily routines,
            the benefits of minimalism are far-reaching.
          </p>
          <p>
          ...
          <p>
            It's important to note that minimalism is not a one-size-fits-all approach. Each individual's journey
            towards a minimalist lifestyle will be unique, shaped by their personal preferences, needs, and
            circumstances. The beauty of minimalism lies in its adaptability, allowing us to tailor it to our own lives
            and find the balance that works best for us.
          </p>
          <p>
